...
//for ($i=0; $i<count($items); $i++){
	...
	echo "<td><font size='20'>" .$items[5]. "</font></td>";
	echo "<td><font size='20'>$" .number_format($prices[5], 2). "</font></td>";
	echo "<td><a href='" .$_SERVER['PHP_SELF']. '?buy=' .'5'. "'><font size='7'>Add to Cart</font></a></td>";
	echo "</tr>";
//}
?>
	</tbody>
