...
<div class="arrival">	
<table align="center" >
<tr><td align="center" colspan="3"><img src="classicoxford.jpg" alt="shoes1" style="width:500px;height:600px;"></td></tr>
...
//for ($i=0; $i<count($items); $i++){
	...
	echo "<td><font size='20'>" .$items[11]. "</font></td>";
	echo "<td><font size='20'>$" .number_format($prices[11], 2). "</font></td>";
	echo "<td><a href='" .$_SERVER['PHP_SELF']. '?buy=' .'11'. "'><font size='7'>Add to Cart</font></a></td>";
	echo "</tr>";
//}
?>
	</tbody>
