...
//for ($i=0; $i<count($items); $i++){
	...
	echo "<td><font size='20'>" .$items[6]. "</font></td>";
	echo "<td><font size='20'>$" .number_format($prices[6], 2). "</font></td>";
	echo "<td><a href='" .$_SERVER['PHP_SELF']. '?buy=' .'6'. "'><font size='7'>Add to Cart</font></a></td>";
	echo "</tr>";
//}
?>
	</tbody>
