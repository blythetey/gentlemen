...
<div class="arrival">	
<table align="center" >
<tr><td align="center" colspan="3"><img src="shoes2.jpg" alt="shoes1" style="width:500px;height:600px;"></td></tr>
...
//for ($i=0; $i<count($items); $i++){
	...
	echo "<td><font size='20'>" .$items[10]. "</font></td>";
	echo "<td><font size='20'>$" .number_format($prices[10], 2). "</font></td>";
	echo "<td><a href='" .$_SERVER['PHP_SELF']. '?buy=' .'10'. "'><font size='7'>Add to Cart</font></a></td>";
	echo "</tr>";
//}
?>
	</tbody>
